/**
 * NeuroNav - WelcomeScreen Component
 * Onboarding modal for user setup
 */
...
// Prism Phase Colors
const PRISM_PHASES = [
  { id: 0, name: 'Introduction', icon: '👋', color: '#FF9F43' },
  { id: 1, name: 'Focus', icon: '🎯', color: '#54A0FF' },
  { id: 2, name: 'Energy', icon: '⚡', color: '#FECA57' },
  { id: 3, name: 'Impulse', icon: '⏱️', color: '#FF5F5F' },
  { id: 4, name: 'Emotions', icon: '💭', color: '#A29BFE' },
  { id: 5, name: 'Strengths', icon: '⭐', color: '#1DD1A1' },
];
